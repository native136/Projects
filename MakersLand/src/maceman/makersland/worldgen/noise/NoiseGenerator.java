package maceman.makersland.worldgen.noise;
...
public class NoiseGenerator {
	...
	/*
	 *  creates a perlin noise using an array of smooth noises with increased octaves.
	 *  this returns an array with large areas of similar values where the individual values
	 *  are different enough so as to leave detail between the variations creating a smoky 
	 *  appearance
	 */
